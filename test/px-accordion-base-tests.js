...
function runBaseTests() {
  px_accordion_1 = document.getElementById('px_accordion_1');

  suite('Base Automation Tests for px-accordion', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-accordion fixture is created', function() {
      assert.isTrue(document.getElementById('px_accordion_1') !== null);
    });
