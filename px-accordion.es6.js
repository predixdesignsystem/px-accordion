  ...
  Polymer({
    ...
    properties: {
      ...
      icons: {
        type: Object,
        value: function() {
          return { 'more': 'px-utl:chevron', 'less': 'px-utl:chevron-right', 'action': 'px-utl:edit' };
        },
    ...
    _iconsChanged: function() {
      this._expandCollapseIcon = this.$.collapse.opened ? this.icons.less : this.icons.more;
    },
    ...
    toggle: function(e) {
      ...
      Polymer.dom(this.root).querySelector('iron-collapse').toggle();
      if (this._expandCollapseIcon === this.icons.more) {
        this.set('_expandCollapseIcon', this.icons.less);
        ...
        this.set('_expandCollapseIcon', this.icons.more);
